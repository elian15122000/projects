...
if(isset($_POST['submit'])){
    ...
    if($stmt->execute()){
        ...
        if($result->num_rows > 0){
            ...
            $stmt = $mysqli->prepare("INSERT INTO calendar (name, email, date, timeslot) VALUES (?,?,?,?)");
    ...
    echo "<script>alert('Termin wurde geblockt.');
...
<body>
    ...
    <div class="container">
        <h1 class="text-center">Zeit für <?php echo date('d.m.Y', strtotime($date)); ?> blocken</h1>
        <hr>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">  
                    <h4 class="modal-title">Blocken <span id="slot"></span></h4>
                        ...
                        <div class="col-md-12">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" name="name" class="form-control" value="<?php echo $username ?>">
                                </div>
                                <div class="form-group">
                                    <label for="">E-Mail (optional)</label>
                                    <input type="email" name="email" class="form-control">
                                </div>
                                <div class="form-group pull-right">
                                    <button class="btn btn-primary" type="submit" name="submit">Blocken</button>
                                </div>
                            </form>
                        </div>
                    </div>
